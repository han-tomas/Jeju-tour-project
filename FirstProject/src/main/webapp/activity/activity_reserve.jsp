...
$(function(){
	...
	$(window).scroll(function(){
	    $("#yourDiv").css("margin-top",Math.max(-450,0-$(this).scrollTop()));
	});
})
</script>
</head>
				...
				<table class="table">
					<tr>
						<td rowspan="2" width="20%">
							<img src="${vo.main_poster }" class="reserveImg">
						</td>
						<td width="80%" style="font-size: 17px; font-weight: bold;  ">${vo.title }</td>
					</tr>
					<tr>
						<td style="color:gray">2023년 7월 23일</td>
					</tr>
				...
				<div class="buyBox">
					<div class="buyBoxContent">
						<table class="table buyBoxAll">
							...
							<tr>
								<td colspan="2">
									<input class="checkbox" style="zoom:2.0;" type="checkbox" id="checkall">
									<label style="position: relative; bottom:6px;">전체 약관 동의</label> 
									<table class="table buyBoxAll" style="font-size: 12pt;">
										<tr>
											<td>
												<input class="checkbox" style="zoom:2.0;" type="checkbox" id="check1">
												<label style="position: relative; bottom:6px;">개인정보 제공 동의 (필수)</label>
											</td>
										</tr>
										<tr>
											<td>
												<input class="checkbox" style="zoom:2.0;" type="checkbox" id="check2">
												<label style="position: relative; bottom:6px;">개인정보 수집 및 이용 동의 (필수)</label>
											</td>
										</tr>
										<tr>
											<td>
												<input class="checkbox" style="zoom:2.0;" type="checkbox" id="check3">
												<label style="position: relative; bottom:6px;">개인정보 국외 이전 동의 (필수)</label>
											</td>
										</tr>
										<tr id="agreeMsg">
							...
							<tr>
								...
								<div class="d-grid">
									<button class="btn btn-block btn-primary btn-wish" style="height: 50px;" disabled="disabled" id="buyBtn">
										<h5>
										<strong>
										<fmt:formatNumber value="${vo.price }" pattern="#,###" />원 결제하기
										</strong>
										</h5>
									</button>
								</div>
