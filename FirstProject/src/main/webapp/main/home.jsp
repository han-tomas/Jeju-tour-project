      ...
      <div class="row">
          ...
          <form id="search-form" name="gs" method="submit" role="search" action="#">
            <div class="row">
              <div class="col-lg-3 align-self-center">
                  <fieldset>
                      <select name="area" style="color:#FF7F31" class="form-select" aria-label="Area" id="chooseCategory" onchange="this.form.click()">
        ...
        <div class="col-lg-10 offset-lg-1">
          <ul class="categories">
            ...
            <li><a href="../hotel/hotel_list.do"><span class="icon"><img src="../assets/images/search-icon-01.png" alt="Hotel"></span> Hotel </a></li>
            <li><a href="#"><span class="icon"><img src="../assets/images/search-icon-02.png" alt="Food"></span> Food </a></li>
            <li><a href="#"><span class="icon"><img src="../assets/images/search-icon-03.png" alt="RentalCar"></span> Cars </a></li>
            <li><a href="#"><span class="icon"><img src="../assets/images/search-icon-06.png" alt="Activity"></span> Activity </a></li>
          </ul>
        </div>
      </div>
    </div>
              ...
              <div class="row">
                <div class="col-lg-3">
                  <div class="menu">
                    ...
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="../assets/images/search-icon-06.png" alt=""></span>
                        Activity
                      </div>
                    </div>
                      ...
                      <span>
                        <c:forEach var="i" begin="1" end="5">
                          <sup style="color: gold">
                            <c:if test="${cvo.score+1>i }">★</c:if>
                          </sup>
                        </c:forEach>
                        <br>
                        <sup>후기 ${cvo.review_count }</sup>
                      </span>
                  ...
                  <div class="listing-item">
                    <div class="left-image">
                      <a href="../hotel/hotel_detail.do?huno=${hvo.huno }">
                        <img src="http://www.jejutori.com/${hvo.poster }" class="recentImg">
                      </a>
                    </div>
                    <div class="right-content align-self-center">
                      <a href="../hotel/hotel_detail.do?huno=${hvo.huno }">
